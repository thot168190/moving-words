...
# In backup content, replace ONLY the inner body of const chapterData = { ... };
# From "const chapterData = {" to "};\n    document.querySelectorAll('.level-switch"
pattern = r'const chapterData = \{.*?\n\};\n    document\.querySelectorAll\(\'\.level-switch'
replacement = js_chapterData + "\n    document.querySelectorAll('.level-switch"
...
final_content = updated_content.replace(old_click, new_click)
...
print("CLEANLY RESTORED & UPDATED 30 SCENES IN BOTH public/learning/index.html AND dist/learning/index.html!")
