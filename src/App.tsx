          ...
          <div className="max-w-lg mx-auto">
            ...
            >
              ...
              <div className="mt-auto">
                ...
                <p className="mt-2 text-[13px] leading-relaxed text-[#6f756f]">결제 후 학습 콘텐츠를 열람하지 않은 상태라면 7일 이내 전액 환불이 가능합니다. 자세한 내용은 <a href="/terms.html" target="_blank" rel="noopener" className="whitespace-nowrap underline">이용약관 제5조</a>를 확인해 주세요.</p>
              </div>
            </motion.div>
          </div>
        </div>
