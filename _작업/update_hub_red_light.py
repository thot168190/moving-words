...
with open("_작업/prompt_traffic_red.txt", "r", encoding="utf-8") as f:
    traffic_red_p = f.read().strip()

SET3_PROMPTS[1]["prompt"] = traffic_red_p
...
print("허브 내 3차 2번 빨간불 신호대기 씬 갱신 완료!")
