# -*- coding: utf-8 -*-
"""
CALM 정본 14개 필수문 100% 충족 + 물리적 획 그리기(Line-tracing) 결합:
- 1. 오프닝: Cinematic progressive line-reveal animation on a solid pure bright white background (#FFFFFF), edge to edge.
- 2. 0-5.5s: hair-thin dark-charcoal linework appears progressively from the empty white field. Each stroke is actively traced across the white field with clear beginning and ending points; the illustration is built progressively rather than fading into view.
- 3. 5.5-8s: an extremely pale, water-heavy watercolor wash develops gently. All color remains low-saturation and transparent, with white showing through every wash. No area becomes dark, dense or fully filled. Use distinct, believable colors for different materials. Restraint means low saturation, not fewer colors or shared hues.
- 4. Style: master-level fine-line illustration with exceptionally thin, pale warm-grey graphite strokes and sophisticated control, maximum line value 25% grey, luminous transparent watercolor, restrained tonal contrast, sophisticated contemporary editorial illustration for thoughtful young learners, generous untouched white space.
"""
...
0-5.5s: hair-thin dark-charcoal linework appears progressively from the empty white field. Every outline is very thin, soft and light, never black or dark charcoal; there are no bold contours, heavy edge lines or dense hatch marks. Each stroke is actively traced across the white field with clear beginning and ending points; the illustration is built progressively rather than fading into view. {reveal_steps} There is no visible person, driver, student, live action element, wall, ceiling, darkness or heavy architecture anywhere. Keep outline curves sparse, pale and softly broken, never darker than 15% grey and never filled as solid outlined blobs. Every detail becomes visible sequentially, never all at once. Previously revealed lines remain delicate and completely stable.
...
set11_scenes = [
    {
        ...
        "reveal_steps": "The slender contoured handle and oval bowl of the ceramic spoon are actively traced first. The two square crystalline sugar cubes are then drawn line by line, followed by the fine edge highlights on the cubes.",
    ...
    },
    {
        ...
        "reveal_steps": "The cylindrical turned wooden body and curved waist outlines are actively traced first. The rotating top dome and small brass screw knob are then drawn line by line, followed by the lower grinding base rings.",
    ...
    },
    {
        ...
        "reveal_steps": "The rectangular flanged ceramic tray outlines are actively traced first. The dome cover and top loop handle are then drawn line by line, followed by the flat wooden spreader lying beside it.",
    ...
    },
    {
        ...
        "reveal_steps": "The rounded glass honey pot outlines are actively traced first. The wooden honey wand with concentric discs is then drawn line by line, followed by the liquid honey level line inside the pot.",
    ...
    },
    {
        ...
        "reveal_steps": "The cylindrical ceramic mug body and sturdy ear handle outlines are actively traced first. The rolled bark scroll of the cinnamon stick is then drawn line by line, followed by the smooth rim circle.",
    ...
    },
    {
        ...
        "reveal_steps": "The circular brass connecting loop ring outlines are actively traced first. The four fan-shaped nested wooden spoon handles are then drawn line by line, followed by the graduated round spoon bowls.",
    ...
    },
    {
        ...
        "reveal_steps": "The faceted vertical glass body outlines are actively traced first. The screw-on domed stainless steel cap is then drawn line by line, followed by the fine crystalline salt level line inside.",
    ...
    },
    {
        ...
        "reveal_steps": "The circular saucer plate and center depression outlines are actively traced first. The small thick-walled espresso cup and loop handle are then drawn line by line, followed by the rich crema surface level line.",
    ...
    },
    {
        ...
        "reveal_steps": "The circular shallow collecting dish outlines are actively traced first. The pointed radial squeezing cone is then drawn line by line, followed by the small handle loop and seed catching slots.",
    ...
    },
    {
        ...
        "reveal_steps": "The circular paddle board outlines are actively traced first. The slender woody olive twig and five slender leaves are then drawn line by line, followed by the two smooth oval green olives.",
...
print("Set 11 [CALM 14개 필수문 완비 + Visibly Traced 결합] 완료!")
